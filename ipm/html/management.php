...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg text-center" id="shwTblBlank"><a href="#" onclick="loadBlank()">View Allocated blanks</a></div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg text-center" id="shwTblBlank"><a href="../PHP/blanks.php">Edit Allocated blanks</a></div>
    </div>
    </div>
    <!-- customer tab -->
    <div class="container-fluid" id="tableContainer">
    <div class="row">
      <div class="col-lg text-center" id="shwTblCustomer" ><a href="#" onclick="loadCustomer()">View Customers</a></div>
    </div>
    <div class="row">    
    ...
    <div class="row">
      <div class="col-lg text-center" id="shwTblBlank"><a href="../PHP/customers.php" >Edit Customers</a></div>
    </div>
</div>
    <!-- staff tab -->
    <div class="container-fluid" id="tableContainer">
    ...
    <div class="row">
      <div class="col-lg text-center" id="shwTblBlank"><a href="../PHP/view_staff.php" >Edit Staff</a></div>
    </div>
</div>
    <!-- discount tab -->
    <div class="container-fluid" id="tableContainer">
    <div class="row">
      <div class="col-lg text-center" id="shwTblDiscount"><a href="#" onclick="loadDiscount()">View Discount</a></div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-lg text-center" id="shwTblBlank"><a href="../PHP/discounts.php" >Edit Discounts</a></div>
    </div>
</div>
  </div>
</body>
